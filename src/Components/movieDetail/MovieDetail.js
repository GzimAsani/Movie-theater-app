  ...
  return (
    <div className="movieDetail-contanier">
      ...
      <div className="movie">
        ...
        <h4>
          A secret agent is given a single word as his weapon and sent to
          prevent the onset of World War III.
          <br />
          He must travel through time and bend the laws of nature in order to be
          successful in his mission
        </h4>

        <div className="movie-text">
          <p>
            <span className="movie-span">Starts</span> - 01.10.2020{" "}
          </p>
          <p>
            <span className="movie-span">Duration of the film</span> - 150 min{" "}
          </p>
          <p>
            <span className="movie-span">State</span> - USA{" "}
          </p>
          <p>
            <span className="movie-span">Genre</span>-Action, Drama, Thriller
          </p>
          <p>
